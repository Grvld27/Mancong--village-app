...
export default function SpotlightSection2() {
...
<div className="mx-auto w-fit mb-10">
      <h1 className='text-5xl font-sans font-bold '>Visit Tanjung Isuy</h1>
      ...
      <SpotlightCard className="h-200 w-350  ">
...
<iframe className="rounded-xl"
  width="100%"
  height="550"
  src="https://youtube.com/embed/kzeP6-qeHAc?loop=5si=df_znB8v2JAbK-0D"
...
></iframe>
   ...
   <SpotlightCard className="mt-10 w-220">
<iframe className="rounded-xl"
  width="100%"
  height="550"
  src="https://youtube.com/embed/YyH27GyewoA?si=99w63UvZNNKyC64p"
  title="YouTube video player"
  frameBorder="2"
  allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
  allowFullScreen
