...
import Blontak from '../assets/Blontakng_di_Lamin_Mancong_150823001.jpg'
...
const CardBlontak = () => {
  return (
    <StyledWrapper>
      <div className="card">
        <img  style = {{width:'32pc', height: 'auto'}}src={Blontak} alt="" />
